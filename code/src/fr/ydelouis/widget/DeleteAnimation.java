...
class DeleteAnimation implements Animator.AnimatorListener,
	...
	public DeleteAnimation(SwipeToDeleteListView listView, ItemState itemState,
			long duration) {
		this.listView = listView;
		this.itemState = itemState;
		float dragPercentage = itemState.getDragPercentage();
		float end = dragPercentage > 0 ? 1f : -1f;
		isLeft = end > 0f ? false : true;
	...
	public void onAnimationEnd(Animator animator) {
		listView.onItemDeleted(itemState, isLeft);
	}
